...
int headers(int* arr1, int* arr2, int* size1, int* size2 ){
	...
	str[0]="University of San Agustin";
	...
	cout<<"		Course Code: CpE 211						Date: 6/27/19 "<<endl;
	cout<<"		Course title: Object Oriented Program				Section: CpE2"<<endl;
	cout<<"		Author: Christian Dave Montalban"<<endl;
	cout<<"		Lab1: Review of C++ Arrays & Strings"<<endl;
	cout<<"________________________________________________________________________________________________________________________";

	len = str[3].length();
	cout<<setw((console_width/2)+len/2)<<right<<str[3]<<endl;
